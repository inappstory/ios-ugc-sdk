...
```ruby
use_frameworks!
pod 'InAppStoryUGC_SwiftUI', :git => 'https://github.com/inappstory/ios-ugc-sdk.git', :tag => '1.1.5-SwiftUI'
```
...
```ogdl
github "inappstory/ios-ugc-sdk" ~> 1.1.5-SwiftUI
```
...
```swift
dependencies: [
    .package(url: "https://github.com/inappstory/ios-ugc-sdk.git", .upToNextMajor(from: "1.1.5-SwiftUI"))
]
```
